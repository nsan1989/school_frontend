        ...
        <Container fluid>
          ...
          <div className="leftContent d-flex">
            ...
            <NavbarBrand className="d-flex align-items-center">
              ...
              />
              <div className="school-name d-none d-md-flex flex-column">
                <h5 className="fw-bold m-0">Concept School</h5>
          ...
          <div className="accountLogout ms-auto">
            <Button title="logout" onClick={handleLogout} variant="link" className="p-0">
      ...
      <div className="d-flex" style={{ height: "100vh" }}>
        ...
        <div
          ...
          style={{
            overflowX: "hidden",
            marginTop: "4rem",
            background: "linear-gradient(135deg, #0071BC, #1B1464)",
